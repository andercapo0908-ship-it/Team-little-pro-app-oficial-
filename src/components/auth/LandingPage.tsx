    ...
    <div className="flex flex-col items-center justify-center h-full w-full max-w-lg mx-auto relative z-10">
      ...
      >
        <div className="relative inline-flex items-center">
          ...
          <motion.div 
            ...
            className="absolute -top-3 -right-3 md:-top-6 md:-right-8 bg-neon text-black px-2 py-0.5 sm:px-3 sm:py-1 text-[9px] md:text-sm font-black italic rounded-[2px] shadow-[0_4px_20px_rgba(57,255,20,0.4)] border border-black/10 z-20"
          >
            PRO
          </motion.div>
        </div>
        ...
        <div className="flex items-center justify-center gap-6 mt-6 opacity-60">
          <div className="h-[1px] w-8 sm:w-16 bg-gradient-to-r from-transparent to-neon" />
          <p className="text-neon text-[9px] sm:text-[10px] tracking-[0.6em] uppercase font-black whitespace-nowrap">Elite Performance Division</p>
          <div className="h-[1px] w-8 sm:w-16 bg-gradient-to-l from-transparent to-neon" />
        </div>
      </motion.div>
      ...
      <div className="w-full space-y-3 pb-8 md:pb-12 mt-4">
        <motion.button
          ...
          className="w-full py-5 bg-neon text-black font-black italic rounded-xl flex items-center justify-center gap-3 transition-all uppercase tracking-[0.2em] text-sm shadow-[0_10px_30px_rgba(57,255,20,0.2)] active:shadow-none"
        >
          SOU ALUNO
        </motion.button>
        
        <motion.button
          whileHover={{ scale: 1.02, backgroundColor: "rgba(57,255,20,0.1)" }}
          whileTap={{ scale: 0.98 }}
          onClick={() => onSelectRole('trainer')}
          className="w-full py-5 bg-transparent border-2 border-neon/40 text-neon font-black italic rounded-xl transition-all uppercase tracking-[0.2em] text-sm hover:border-neon backdrop-blur-sm"
        >
          SOU PERSONAL
        </motion.button>
        ...
        <div className="flex justify-center pt-6 opacity-20">
           ...
           <div className="w-2 h-2 rounded-full bg-white/50 mx-1" />
           <div className="w-2 h-2 rounded-full bg-neon mx-1" />
        </div>
      </div>

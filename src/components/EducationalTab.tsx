  ...
  return (
    <div className="p-6 md:p-10 pb-32 max-w-7xl mx-auto space-y-10">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
        <div>
          <h2 className="text-5xl md:text-7xl font-black italic uppercase tracking-tighter leading-none mb-2">EDUCACIONAL <span className="text-neon">PRO</span></h2>
          <p className="text-neon/60 font-mono text-[10px] uppercase tracking-[0.5em] font-black">Biblioteca de Performance e Conhecimento</p>
        </div>
        
        {isTrainerOrAdmin && (
          <button 
            onClick={() => setIsAdding(true)}
            className="group bg-neon text-black px-8 py-5 rounded-2xl font-black italic uppercase tracking-widest text-xs flex items-center gap-3 hover:bg-white transition-all shadow-[0_0_30px_rgba(57,255,20,0.2)] hover:shadow-neon/40 h-fit"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          <div className="lg:col-span-2 relative">
             ...
             <input 
              ...
              className="w-full bg-neutral-900 border border-white/5 rounded-[2rem] py-5 pl-16 pr-8 text-white outline-none focus:border-neon transition-all shadow-2xl"
             />
          </div>
          ...
          <div className="relative group">
            ...
            <select 
              ...
              className="w-full bg-neutral-900 border border-white/5 rounded-[2rem] py-5 pl-16 pr-8 text-white outline-none focus:border-neon appearance-none font-black italic uppercase text-xs tracking-widest cursor-pointer shadow-2xl"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredItems.map(item => (
            <motion.div 
              ...
              className="group bg-neutral-900/50 border border-white/5 rounded-[3rem] overflow-hidden flex flex-col shadow-2xl hover:border-neon/30 transition-all"
            >
                ...
                {item.type === 'video' && item.url ? (
                  <div className="w-full h-full relative cursor-pointer" onClick={() => setActiveItem(item)}>
                     ...
                     <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-16 h-16 bg-neon rounded-full flex items-center justify-center text-black shadow-2xl group-hover:scale-110 transition-transform">
              ...
              <div className="p-10 flex-1 flex flex-col">
                ...
                <div className="mt-auto space-y-6">
                  ...
                  <button 
                    ...
                    className="w-full bg-white/5 hover:bg-neon hover:text-black py-4 rounded-2xl flex items-center justify-center gap-3 text-[10px] font-black italic uppercase tracking-[0.2em] transition-all"
                  >
          ...
          <div className="fixed inset-0 flex items-center justify-center z-[200] p-4">
            ...
            >
              <div className="flex justify-between items-center mb-12">
                <h2 className="text-4xl font-black italic uppercase tracking-tighter">POSTAR <span className="text-neon">CONTEÚDO</span></h2>
              ...
              <form onSubmit={handleSave} className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      ...
                      {CONTENT_TYPES.map(type => (
                        <button
                          ...
                          className={`flex-1 py-3 flex flex-col items-center gap-1 rounded-xl transition-all ${
                            formData.type === type.id ? 'bg-neon text-black' : 'text-slate-500 hover:text-white'
                          }`}
                        >
                          <type.icon size={16} />
                  ...
                  <div className="space-y-2">
                    ...
                    <select 
                      ...
                      className="w-full bg-black/40 border border-white/10 rounded-2xl py-5 px-6 text-white outline-none focus:border-neon appearance-none font-black italic uppercase text-[10px] tracking-widest"
                    >
                      {CATEGORIES.map(cat => <option key={cat} value={cat}>{cat.toUpperCase()}</option>)}
                    </select>
                  </div>
                ...
                <div className="space-y-2">
                   ...
                   <input 
                    ...
                    className="w-full bg-black/40 border border-white/10 rounded-2xl py-5 px-6 text-white outline-none focus:border-neon font-black italic uppercase tracking-widest text-sm" 
                   />
                </div>
                ...
                <div className="space-y-2">
                   ...
                   <textarea 
                    ...
                    className="w-full bg-black/40 border border-white/10 rounded-2xl py-5 px-6 text-white outline-none focus:border-neon text-sm italic" 
                   />
                </div>
                ...
                {formData.type === 'video' ? (
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full bg-black/40 border border-white/10 rounded-2xl py-5 px-6 text-white outline-none focus:border-neon font-mono text-sm" 
                    />
                  </div>
                ) : (
                  <div className="space-y-2">
                    ...
                    <textarea 
                      ...
                      className="w-full bg-black/40 border border-white/10 rounded-3xl py-6 px-8 text-white outline-none focus:border-neon text-sm leading-relaxed" 
                    />
                  </div>
                )}
                ...
                <button 
                  type="submit"
                  className="w-full bg-neon text-black py-6 rounded-3xl font-black italic uppercase tracking-[0.3em] shadow-xl shadow-neon/20 hover:bg-white transition-all transform hover:-translate-y-1 active:translate-y-0"
                >
              ...
              <div className="p-8 md:p-12 border-b border-white/5 flex justify-between items-center bg-black/40">
                <div className="flex items-center gap-4">
                   <div className="p-3 bg-neon/10 rounded-2xl">
                      {activeItem.type === 'video' ? <Video className="text-neon" size={24} /> : <FileText className="text-neon" size={24} />}
                   </div>
                   <div>
                      <p className="text-[10px] font-black uppercase text-neon tracking-[0.4em] mb-1">{activeItem.category}</p>
              ...
              <div className="flex-1 overflow-y-auto p-8 md:p-16 custom-scrollbar">
                {activeItem.type === 'video' && activeItem.url ? (
                  ...
                  <div className="max-w-4xl mx-auto space-y-10">
                     ...
                     <p className="text-neon font-black italic uppercase tracking-[0.3em] border-l-2 border-neon pl-6">Resumo: {activeItem.description}</p>
              ...
              <div className="p-8 border-t border-white/5 bg-black/40 flex flex-col md:flex-row justify-between items-center gap-6">
                 <div className="flex items-center gap-4">
                    <img 
                      ...
                      className="w-12 h-12 rounded-full border-2 border-neon/30"
                    />
                    <div>
                      <p className="text-[10px] font-black uppercase text-neon tracking-widest">Publicado por</p>

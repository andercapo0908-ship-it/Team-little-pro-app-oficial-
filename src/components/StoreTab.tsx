...
export const StoreTab = React.memo(({ profile }: { profile: UserProfile | null }) => {
  return (
    <div className="p-6 md:p-8 pb-32 max-w-6xl mx-auto space-y-10">
      <div className="text-center py-20 border border-white/5 border-dashed rounded-[3rem]">
        <ShoppingBag size={48} className="mx-auto text-amber-500/20 mb-6" />
        <h2 className="text-3xl font-black italic uppercase tracking-tighter mb-2">Loja <span className="text-amber-500">Exclusiva</span></h2>
